...
<body>
       ...
       <br>
       <p class="p-2  border-danger text-center text-danger"><i class="fa fa-warning"></i> If you change the structure of the form than your previous responses will be deleted.</p>
      <br>
 ...
 <button class="d-none"  data-toggle="modal" data-target="#responseModal" id="responseModalShowButton">hey</button>                      
  ...
  <div class="bottom d-block d-sm-none w-100">
    ...
    function loadData(){
      ...
      xhttp.send("fid=${fid}&type=survey");
