...
<%
   ...
   List<JSONObject> json_object_list = new ArrayList();
    ...
    if (fid==null){
         ...
         fid = getFormId();
         String href_val = "quizze.jsp?id="+fid;
         ...
         ps.setString(10,"quizze");
         int success = ps.executeUpdate();
         if(success==0)
            out.print("error in form_data table");
         
           Statement st = conn.createStatement();
           String sql = "create table quizze_metadata_"+fid+"(type varchar(20),label varchar(90),value varchar(90),optimality varchar(5),answer varchar(80)";
           st.executeUpdate(sql);
           ps = conn.prepareStatement("insert into quizze_metadata_"+fid+"  values(?,?,?,?,?)");
           sql = "create table quizze_data_" + fid+"(";
          for (int i=0;i<json_object_list.size();i++)
           {
               ...
               ps.setString(5,(String)json_obj.get("answer"));
    ...
    else
    {
         ...
         if (change_tracker==true){
               ps = conn.prepareStatement("drop table quizze_metadata_"+fid.toLowerCase());
               ps.executeUpdate();
               ps = conn.prepareStatement("drop table quizze_data_"+fid.toLowerCase());
               ps.executeUpdate();
           ...
           message = "! your quizze is edited successfully ";
    }
