...
<html lang="en"> 
  ...
  *{
  ...
  #form-container{ border-top:8px solid green;font-family:Trocchi; }
  .font-Trocchi{ font-family:Trocchi; }
  #right-column{ background:rgb(248,249,250);}
   ...
   <a class="logo" href="index.html">SURVEY.COM</a>
    ...
    <div class=" mx-auto" id="main-container">
     ...
     <div class="form-group">
         <input type="text" class="form-control font-Trocchi"  name="title" id="title"  placeholder="Enter Title" onkeyup="fillHeader(this)">
    </div>
      <div class="mb-2 sticky-top bg-light pt-1 pb-1 d-none d-md-block"> 
       ...
       <div class="bodrer p-md-4 p-2  mx-auto"  id="right-column">
            <div class="p-2 p-md-3  rounded-lg   mx-auto d-block"  id="form-container" style="background:white;">
                <h3 class="form-header p-2"></h3><br>
            </div> 
        </div>
    </div>
          ...
          <div class="row">
              ...
              <div class="col-6 p-3">
                    <div class="form-group p-0">
                        <input type="color"  class="form-contol" value="#F8F9FA"  onchange="changeBgColor(this)" ><br>
                    </div>
                </div>
          </div>
          <div class="row">
              ...
              <div class="col-6 p-3">
                    <div class="form-group p-0">
                        <input type="color" class="form-cotrol" value="#008000" onchange="changeBorderColor(this)" ><br>
                     </div>
                </div>
          </div>
          <div class="row">
 ...
 <button class="d-none"  data-toggle="modal" data-target="#responseModal" id="responseModalShowButton">hey</button>                      
  ...
  <div class="bottom d-block d-sm-none w-100">
    ...
    <script>
        ...
        var count = 0 ;
        var numbering = 1;
        var font_family="toricchi",border_color="#008000",background_color="#F8F9FA",title_text="";
       ...
       function addCheckBox(index){
          ...
          var obj  = {type:"checkbox",label:label_v,value:data_v,optimality:isrequired};
     ...
     function addRadio(index){
          ...
          var  label_v = label.value;
          var  data_v  = data.value;
          var obj  = {type:"radio",label:label_v,value:data_v,optimality:isrequired};
          var  values = data_v.split(",");
     ...
     function addList(index){
          ...
          var  label_v = label.value;
          var  data_v  = data.value;
          var obj  = {type:"list",label:label_v,value:data_v,optimality:isrequired};
           var  values = data_v.split(",");
    ...
    function addInputBox(index){
          ...
          var  label_v = label.value;
          var  data_v  = data.value;
          var obj  = {type:data_v,label:label_v,value:"",optimality:isrequired};
    ...
    for (x in form_meta_data)
      ...
      xhttp.open("POST", "form_metadata_store.jsp", true);
      xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
      xhttp.send("data="+form_meta_data_json+"&setting="+settings);
    }
    else{
