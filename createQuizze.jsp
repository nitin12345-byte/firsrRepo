   ...
   <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-top rounded-lg">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label>Data(enter the values separating with comma(,):</label>
              <textarea class="form-control" name="c_data"  ></textarea>
          </div>
          <div class="form-group">
              <label>Answer (enter the values separating with comma(,):</label>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-top rounded-lg">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label>Answer (enter the values separating with comma(,):</label>
              <input type="text" class="form-control" name="r_answer">
          </div>
          <div class="form-group">
  ...
  <div class="bottom d-block d-sm-none w-100">
    ...
    for (x in form_meta_data)
      ...
      xhttp.send("data="+form_meta_data_json+"&setting="+settings);
             ...
             error.innerHTML = "<i class='fa fa-warning'></i>Please give a title to the quizze."
      ...
      error.style.display = "block";
      error.innerHTML = "<i class='fa fa-warning'></i>Form is Empty first make quizze and then save."
     }
   } 
